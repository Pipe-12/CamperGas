...
class SaveVehicleConfigUseCase @Inject constructor(
    ...
    /**
     * Guarda o actualiza la configuración del vehículo mediante un objeto completo.
     * 
     * Persiste el objeto VehicleConfig directamente en la base de datos.
     * Si ya existe una configuración, la reemplaza.
     * 
     * Esta variante es útil cuando ya se tiene un objeto VehicleConfig construido,
     * evitando tener que extraer cada propiedad individualmente.
     * 
     * Esta función debe llamarse desde una coroutine o función suspend.
     * 
     * @param config Objeto VehicleConfig completo con todas las propiedades configuradas
     */
